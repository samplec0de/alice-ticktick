...
**Слоты:** `task_name` (STRING), `date` (DATETIME), `priority` (STRING), `rec_freq` (STRING), `rec_interval` (NUMBER), `rec_monthday` (NUMBER), `reminder_value` (NUMBER), `reminder_unit` (STRING)
