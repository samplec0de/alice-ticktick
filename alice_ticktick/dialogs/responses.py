...
HELP = (
    ...
    "\n\nСкажите «помощь с [темой]» для подробностей, например: «помощь с созданием»."
)
...
EVENING_BRIEFING_NO_TASKS_OVERDUE = (
    "Итоги дня! На завтра задач нет, но есть {overdue_count} просроченных. Хорошего вечера!"
)
